...
#define RC5_SIMPLE_SIGNATURE "AraHnID" // Strong 7 bytes
...
public:
 ...
 void RC5_DecryptFileRQFF(unsigned char *in_name, vector<unsigned char> &out_name);
 void RC5_DecryptFileRQFF(const char *in_name, vector<unsigned char> &out_name);

 void RC5_EncDecFile(unsigned char *in_name, unsigned char *out_name, int mode);
 void RC5_DecFileForRQFF(unsigned char *in_name, vector<unsigned char> &);
